# Autogenerated wrapper script for Shaderc_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libSPIRV_Tools_shared, "@rpath/libSPIRV-Tools-shared.dylib")
JLLWrappers.@declare_library_product(libshaderc_shared, "@rpath/libshaderc_shared.1.dylib")
